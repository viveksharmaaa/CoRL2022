...
np = pyimport("numpy")
vars = npzread("/home/vivek/PycharmProjects/CoRL2022/Npz_files/CAR.npz")
...
function Wf(x)
        ...
        xbot = ones(1,1)       #reshape(x[effective_dim_start+1:effective_dim_end-num_dim_control],(1,effective_dim_end-num_dim_control-effective_dim_start))
...
npzwrite("CAR_sampled.npz",Dict("xd" => xd, "x" => xc, "RE" => RME))
print("DONE")
